      ...
      <div ref={contentRef} className="relative z-20 w-full section-padding pt-32 pb-48">
        ...
        <div className="max-w-4xl">
          ...
          <a
            ...
            className="group inline-flex items-center gap-3 px-8 py-4 bg-brand-green text-white font-semibold rounded-xl transition-all duration-300 hover:bg-brand-green-600 hover:shadow-xl hover:shadow-brand-green/30 hover:-translate-y-1 active:scale-95 no-underline"
