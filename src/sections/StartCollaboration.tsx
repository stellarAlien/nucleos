...
const StartCollaboration = () => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 right-0 -translate-y-1/2 translate-x-1/2 w-[600px] h-[600px] bg-teal-50 rounded-full blur-3xl opacity-50" />
            <div className="absolute bottom-0 left-0 translate-y-1/2 -translate-x-1/2 w-[500px] h-[500px] bg-emerald-50 rounded-full blur-3xl opacity-50" />
            ...
            <div className="container mx-auto px-6 relative z-10">
                ...
                >
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-teal-50 text-teal-700 rounded-full mb-8 font-semibold text-sm tracking-wide uppercase border border-teal-100/50">
                        <Mail className="w-4 h-4" />
                        Get in Touch
                    </div>

                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-slate-900 mb-8 leading-tight">
                        Start <span className="text-transparent bg-clip-text bg-gradient-to-r from-teal-500 to-emerald-500">Collaboration</span>
                    </h2>
                    ...
                    <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
                        ...
                        <div className="text-slate-500 font-medium">
                            ...
                            <a
                                href="mailto:info@nucleos-biotech.com"
                                className="text-teal-600 hover:text-teal-700 transition-colors underline underline-offset-4 decoration-teal-200"
                            >
